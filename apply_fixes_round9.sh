...
#   bash apply_fixes_round9.sh
# Then open Supabase SQL Editor and run exam_admin_schema.sql
set -e

cat > exam_admin_schema.sql << 'TRYIT_EOF'
...
TRYIT_EOF
echo "wrote exam_admin_schema.sql"

echo "Done — paste exam_admin_schema.sql into Supabase SQL Editor and run it."
